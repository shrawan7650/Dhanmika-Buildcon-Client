...
import { AboutBrotherSection, TeamSection } from "@/components/sections/team-section"
...
export const metadata: Metadata = {
  title: "About Us",
  description:
    "Learn about Dhanmika Interiors - our story, team, values, and approach to creating exceptional interior design experiences.",
  openGraph: {
    title: "About Dhanmika Interiors | Our Story & Team",
    ...
    <div className="min-h-screen">
      ...
      {/* <section className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl font-bold font-playfair mb-6">About Dhanmika Interiors</h1>
