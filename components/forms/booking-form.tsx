...
const bookingSchema = z.object({
  ...
  projectRequirements: z.string().min(10, "Please describe your project requirements"),
...
const budgetRanges = ["$5,000 - $15,000", "$15,000 - $30,000", "$30,000 - $50,000", "$50,000 - $100,000", "$100,000+"]
  ...
  const onSubmit = async (data: BookingFormData) => {
    ...
    try {
      await submitBooking({
        ...
        status: "pending",
        createdAt: new Date(),
        inspirationImages: selectedFiles ? Array.from(selectedFiles) : [],
      })
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div>
            ...
            <Select onValueChange={(value) => setValue("service", value)}>
              ...
              <SelectContent>
                ...
                <SelectItem value="color-styling">Color & Styling</SelectItem>
              </SelectContent>
            </Select>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <Select onValueChange={(value) => setValue("preferredTime", value)}>
                <SelectTrigger className={cn(errors.preferredTime && "border-red-500")}>
          ...
          <div>
            ...
            {errors.projectRequirements && (
              <p className="text-sm text-red-500 mt-1">{errors.projectRequirements.message}</p>
            )}
          </div>
